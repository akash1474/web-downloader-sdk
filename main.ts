...
const urls: { url: string; filename: string }[] = [
  ...
  {
    url: "http://localhost:3000/Such a Whore - JVLA.mp3",
    filename: "Such a Whore - JVLA.mp3",
  },
  {
    url: "http://localhost:3000/Sugar & Brownies - DHARIA.mp3",
    filename: "Sugar & Brownies - DHARIA.mp3",
  },
  {
    url: "http://localhost:3000/Sweet Dreams (Are Made of This) - Remastered.mp3",
    filename: "Sweet Dreams (Are Made of This) - Remastered.mp3",
  },
  {
    url: "http://localhost:3000/Tere Liye (Lofi Mix).mp3",
    filename: "Tere Liye (Lofi Mix).mp3",
  },
  {
    url: "http://localhost:3000/Tourner Dans Le Vide - Indila.mp3",
    filename: "Tourner Dans Le Vide - Indila.mp3",
  },
  {
    url: "http://localhost:3000/Venom - Music From The Motion Picture - Eminem.mp3",
    filename: "Venom - Music From The Motion Picture - Eminem.mp3",
  },
  {
    url: "http://localhost:3000/6933742264.pdf",
    filename: "Sapphire - Ed Sheeran.mp3",
  },
  {
    url: "http://localhost:3000/Stride.svg",
    filename: "Stride.svg",
  },
];
